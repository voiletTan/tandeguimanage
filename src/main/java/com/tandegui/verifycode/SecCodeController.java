package com.tandegui.verifycode;
...
/**
 * 验证码
 * Created by Waiter Tan on 2019.4.10.
 */
public class SecCodeController extends HttpServlet {
    ...
    private static final String CAPTCHA_ATTR = SecCodeController.class.getName().concat(".CAPTCHA");
